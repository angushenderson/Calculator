...
button0 = Button(window, text='0', bg='black',fg='white',command=lambda:num(0))
button1 = Button(window, text='1', bg='black',fg='white',command=lambda:num(1))
button2 = Button(window, text='2', bg='black',fg='white',command=lambda:num(2))
button3 = Button(window, text='3', bg='black',fg='white',command=lambda:num(3))
button4 = Button(window, text='4', bg='black',fg='white',command=lambda:num(4))
button5 = Button(window, text='5', bg='black',fg='white',command=lambda:num(5))
button6 = Button(window, text='6', bg='black',fg='white',command=lambda:num(6))
button7 = Button(window, text='7', bg='black',fg='white',command=lambda:num(7))
button8 = Button(window, text='8', bg='black',fg='white',command=lambda:num(8))
button9 = Button(window, text='9', bg='black',fg='white',command=lambda:num(9))
